<div class="modal fade" id="mdlShowOrdenCompra" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    ...
    async function openMdlShowOrdenCompra(id){
        ...
        $('#mdlShowOrdenCompra').modal('show');
    }

    $('#mdlShowOrdenCompra').on('hidden.bs.modal', function (e) {
        limpiarModalShow();
    });
    ...
    async function getShowOrdenCompra(orden_compra_id){
        ...
        const urlShowOrdenCompra        =   `{{ route('compras.orden_compra.show', ':id') }}`.replace(':id', orden_compra_id);

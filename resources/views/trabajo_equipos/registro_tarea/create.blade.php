...
<div class="card-style settings-card-1 mb-30">
    ...
    <div class="card-body">
        @include('trabajo_equipos.registro_tarea.forms.form_create_registro_tarea')
    </div>
...
<script>
    ...
    function registrarTarea(){
        ...
        text: "Se creará un registro del viaje de la maquinaria!",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            ...
            const urlRegistrarTarea         =   @json(route('trabajo_equipos.registro_tarea.store'));
            ...
            try {
                ...
                if(res.success){
                    const producto_index     =   @json(route('trabajo_equipos.registro_tarea.index'));

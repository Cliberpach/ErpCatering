    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
            ...
            <div class="input-group ">
                ...
                <input required id="descripcion" name="descripcion" type="text" class="form-control" placeholder="Cargo" aria-label="Example text with button addon" aria-describedby="button-addon1">
            </div>              

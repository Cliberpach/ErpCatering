...
<body>
    <div class="container">
        ...
        <table class="solicitud-table">
            <tr>
                <td>REPORTE DE SALIDA DE ALMACÉN</td>
            </tr>
        </table>
        ...
        <table class="footer-table">
            ...
            <tr>
                <td>USUARIO:</td>
                <td>{{$registro_salida->colaborador_nombre}}</td>
            </tr>
            <tr>
                <td>ALMACÉN ORIGEN:</td>
                <td>{{$registro_salida->almacen_origen_nombre}}</td>
            </tr> 
            <tr>
                <td>ALMACÉN DESTINO:</td>
                <td>{{$registro_salida->almacen_destino_nombre}}</td>
            </tr>
            <tr>
                <td>FECHA REGISTRO:</td>
                <td>{{$registro_salida->created_at}}</td>
            </tr>
            <tr>

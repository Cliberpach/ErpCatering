<div class="modal fade" id="mdlProductosCotizacionToOrden" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    ...
    function openMdlProductos(){
        $('#mdlProductosCotizacionToOrden').modal('show');
    }
    ...
    function seleccionarProducto(producto_id) {
        ...
        $('#mdlProductosCotizacionToOrden').modal('hide');

...
<div class="card-style settings-card-1 mb-30">
    ...
    <div class="card-body">
        @include('registros.proyectos.forms.form_edit_proyecto')
    </div>
    <div class="card-footer d-flex justify-content-between align-items-center">
        ...
        <div style="display:flex;">
            ...
            <button class="btn btn-primary" type="submit" form="formActualizarProyecto">
...
<script>
    ...
    function events(){
        document.querySelector('#formActualizarProyecto').addEventListener('submit',(e)=>{
            e.preventDefault();
            actualizarProyecto();
        })
    ...
    function actualizarProyecto(){
        ...
        title: "DESEA ACTUALIZAR EL PROYECTO?",
        text: "Se actualizaran los datos del proyecto!",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            ...
            const formActualizarProyecto    =   document.querySelector('#formActualizarProyecto');
            const formData                  =   new FormData(formActualizarProyecto);

            Swal.fire({
                title: 'Cargando...',
                html: 'Actualizando proyecto...',
            ...
            try {
                const id                 =   @json($proyecto->id);
                let urlUpdateProyecto    =   `{{ route('registros.proyecto.update', ['id' => ':id']) }}`;
                urlUpdateProyecto        =   urlUpdateProyecto.replace(':id', id);

                const response  =   await fetch(urlUpdateProyecto, {
                                        method: 'POST',
                                        headers: {
                                            'X-CSRF-TOKEN': token,
                ...
                toastr.error(error,'ERROR EN LA PETICIÓN ACTUALIZAR PROYECTO');
                Swal.close();
            }

...
@section('consulta_maquinaria-active', 'active')
...
<div class="card-style settings-card-1 mb-30">
    ...
    <div class="table-responsive">
        @include('consultas.maquinaria.tables.table_list')
    </div>
</div>
@endsection
...
<script>
    ...
    document.addEventListener('DOMContentLoaded',()=>{
        iniciarDataTableConsultaMaquinaria();
        iniciarSelect2();
    })
    ...
    function iniciarDataTableConsultaMaquinaria(){
        const urlGetConsultaMaquinaria = '{{ route('consultas.maquinaria.getConsultaMaquinaria') }}';
    ...
    function exportarPDF(){
        ...
        const url = '{{ route('consultas.maquinaria.pdf') }}' + `?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}&proyecto_id=${proyectoId}`;
    ...
    function exportarExcel(){
        ...
        const url = '{{ route('consultas.maquinaria.excel') }}' + `?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}&proyecto_id=${proyectoId}`;

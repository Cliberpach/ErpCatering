<form action="" id="formRegistrarRegimen" method="post">    
    <div class="row">
        @csrf      
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group mb-3">
                ...
                <textarea required id="descripcion" maxlength="500" name="descripcion" class="form-control" placeholder="Descripción" aria-label="Descripción" aria-describedby="basic-addon1"></textarea>
            </div>                  
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input required id="dias_trabajo" name="dias_trabajo" type="number" min="1" class="form-control" placeholder="Días de Trabajo" aria-label="Días de Trabajo" aria-describedby="basic-addon1">
            </div>                  
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input required id="dias_descanso" name="dias_descanso" type="number" min="1" class="form-control" placeholder="Días de Descanso" aria-label="Días de Descanso" aria-describedby="basic-addon1">
            </div>                  

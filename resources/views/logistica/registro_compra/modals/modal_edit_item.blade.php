    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
           ...
           @include('logistica.registro_compra.forms.form_edit_item')
...
<script>
    ...
    function deleteItem(producto_id){
        ...
        const indiceProducto    =   lstCompra.findIndex((lcd)=>{
        ...
        lstCompra.splice(indiceProducto,1);
        return true;
    ...
    function actualizarItem(dataFormEdit){
        ...
        lstCompra[indiceProducto].cantidad      =   dataFormEdit.cantidad;
        lstCompra[indiceProducto].precio        =   dataFormEdit.precio;
        lstCompra[indiceProducto].total         =   parseFloat(dataFormEdit.precio) * parseFloat(dataFormEdit.cantidad);
        lstCompra[indiceProducto].almacen_id    =   dataFormEdit.almacen_id;
        lstCompra[indiceProducto].almacen_nombre=   dataFormEdit.almacen_nombre;
    ...
    function setProducto(producto_id){
        ...
        const productoIndice    =   lstCompra.findIndex((lcd)=>{
            return lcd.producto_id == producto_id;
        })
        ...
        const producto_find   =   lstCompra[productoIndice];

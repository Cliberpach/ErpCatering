<form action="" id="formRegistrarVehiculo" method="post">    
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group">
                <span class="input-group-text" id="basic-addon1">
                    <img width="30" height="30" src="{{asset('img/icons/placa/placa1.png')}}" alt="coins"/>                   
                </span>
            ...
            <span style="color:rgb(0, 89, 255);display:block; font-style: italic;">(6 - 8 CARACTERES)</span>                                
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group">
                <span class="input-group-text" id="basic-addon1">
                    <img width="30" height="30" src="{{asset('img/icons/etiqueta/etiqueta1.png')}}" alt="coins"/>                   
                </span>

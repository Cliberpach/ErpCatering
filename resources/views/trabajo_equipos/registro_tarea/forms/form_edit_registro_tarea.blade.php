<form action="" id="formActualizarTarea" method="post">    
    <div class="row">
            @csrf  
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
                ...
                <select required name="maquinaria" required class="form-select select2_form" id="maquinaria" data-placeholder="Seleccionar">
                    ...
                    @foreach ($maquinarias as $maquinaria)
                        <option
                        @if ($maquinaria->maquinaria_id === $registro_tarea->maquinaria_id)
                            selected
                        @endif
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input value="{{$registro_tarea->cantidad_horas_viajes}}" required id="cant_horas_viajes" maxlength="20"  name="cant_horas_viajes" type="text" class="form-control inputEnteroPositivo" placeholder="N° Horas o Viajes" aria-label="Username" aria-describedby="basic-addon1">             
                </div>                  
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <textarea  maxlength="300" class="form-control" name="observacion" placeholder="Leave a comment here" id="observacion">{{$registro_tarea->observacion}}</textarea>

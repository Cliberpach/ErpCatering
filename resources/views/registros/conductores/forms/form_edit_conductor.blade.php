    ...
    <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                ...
                <div class="input-group">
                    ...
                    <input minlength="9" maxlength="10" value="{{$conductor->licencia}}" required id="licencia" maxlength="100"  name="licencia" type="text" class="form-control numero-input" placeholder="Licencia" aria-label="Username" aria-describedby="basic-addon1">
                </div>   
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                ...
                <div class="input-group">
                    ...
                    <input value="{{$conductor->telefono}}" maxlength="20"  id="telefono" name="telefono" type="text" class="form-control numero-input" placeholder="Teléfono" aria-label="Username" aria-describedby="basic-addon1">
                </div>      

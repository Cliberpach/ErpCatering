      ...
      <ul>
        ...
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_2" class="collapse dropdown-nav">
            ...
            <li>
                <a href="blank-page.html">Categoría</a>
            </li>
            <li>
                <a href="blank-page.html">Marca</a>
            </li>
            <li>
        ...
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_6" class="collapse dropdown-nav">
            <li>
              <a href="{{route('herramientas.usuario.index')}}">Usuarios</a>
            </li>
            <li>
              <a href="buttons.html"> Roles </a>
            </li>
            <li>
              <a href="cards.html"> Registro Tipo Documento </a>
            </li>
            <li>
              <a href="typography.html">Empresa</a>
            </li>
          </ul>
        </li>
        <li class="nav-item nav-item-has-children">

<form action="" id="formActualizarMaquinaria" method="post">    
    <div class="row">
        @csrf      
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input value="{{$maquinaria->nombre}}" required id="nombre" maxlength="260"  name="nombre" type="text" class="form-control" placeholder="Nombre" aria-label="Username" aria-describedby="basic-addon1">
             </div>                  
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <select required name="tipo_gasto" required class="form-select select2_form" id="tipo_gasto" data-placeholder="Seleccionar">
                ...
                @foreach ($tipos_gasto as $tipo_gasto)
                    <option
                    @if ($maquinaria->tipo_gasto_id === $tipo_gasto->id)
                        selected
                    @endif
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            <label class="mb-2" for="observacion"  style="font-weight: bold;">OBSERVACIÓN</label>
            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">
                    <i class="fa-solid fa-keyboard"></i>                  
                </span>
                <div class="form-floating">
                    <textarea name="observacion" id="observacion" value="{{$maquinaria->observacion}}" class="form-control" placeholder="Observación" id="floatingTextarea"></textarea>

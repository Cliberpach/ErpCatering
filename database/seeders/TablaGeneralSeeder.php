...
class TablaGeneralSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $tabla_general_unidades_medida->simbolo =   'unidades_medida';
        ...
        foreach ($unidades_medida as $unidad_medida) {
            ...
            $item->descripcion      = $unidad_medida['descripcion'];
            $item->simbolo          = $unidad_medida['simbolo'];

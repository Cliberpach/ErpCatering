...
<div class="card-style settings-card-1 mb-30">
    ...
    <div class="card-body">
        @include('registros.conductores.forms.form_edit_conductor')
    </div>
    <div class="card-footer d-flex justify-content-between align-items-center">
        ...
        <div style="display:flex;">
            ...
            <button class="btn btn-primary" type="submit" form="formActualizarConductor">
...
<script>
    ...
    function actualizarConductor(){
        ...
        text: "Se actualizaran los datos del conductor!",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                const id                        =   @json($conductor->id);
                let urlUpdateConductor    =   `{{ route('registros.conductor.update', ['id' => ':id']) }}`;
                urlUpdateConductor        =   urlUpdateConductor.replace(':id', id);

                const response  =   await fetch(urlUpdateConductor, {
                                        method: 'POST',
                                        headers: {
                                            'X-CSRF-TOKEN': token,

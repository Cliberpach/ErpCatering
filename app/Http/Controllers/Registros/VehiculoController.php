...
use App\Http\Requests\Registros\Vehiculo\VehiculoStoreRequest;
use App\Http\Requests\Registros\Vehiculo\VehiculoUpdateRequest;
...
class VehiculoController extends Controller
{
    public function index(){
        return view('registros.vehiculos.index');
    }
    ...
    public function create(){
        return view('registros.vehiculos.create');
    }
    ...
    */
    ...
    public function edit($id){
        ...
        return view('registros.vehiculos.edit',compact('vehiculo'));
    }

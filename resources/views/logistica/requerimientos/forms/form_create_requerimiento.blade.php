<form action="" id="formRegistrarRequerimiento" method="post">    
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
            <label class="required_field" for="proveedor" style="font-weight: bold;">PROVEEDOR SUGERIDO</label> <i class="fa-solid fa-plus btn btn-primary" onclick="openMdlNuevoProveedor();"></i>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    @include('logistica.requerimientos.tables.table_requerimiento_detalle')
                                </div>
                            </div>
                        </div>
                    </div>

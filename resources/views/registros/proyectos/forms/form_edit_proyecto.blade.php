    ...
    <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input value="{{$proyecto->costo}}" value="1.00" required id="costo" maxlength="20"  name="costo" type="text" class="form-control numero-input costo" placeholder="Precio" aria-label="Username" aria-describedby="basic-addon1">
                </div>                  
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input value="{{$proyecto->avance_costo}}" value="0.00" required id="avance_costo" maxlength="20"  name="avance_costo" type="text" class="form-control numero-input avance_costo" placeholder="Precio" aria-label="Username" aria-describedby="basic-addon1">
                </div>                  
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input value="{{$proyecto->diferencia}}" readonly value="1.00" required id="diferencia" maxlength="20"  name="diferencia" type="text" class="form-control numero-input" placeholder="Precio" aria-label="Username" aria-describedby="basic-addon1">
                </div>                  

    ...
    <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                ...
                <div class="input-group">
                    ...
                    <input minlength="9" maxlength="10" required id="licencia" maxlength="100"  name="licencia" type="text" class="form-control" placeholder="Licencia" aria-label="Username" aria-describedby="basic-addon1">
                </div>            

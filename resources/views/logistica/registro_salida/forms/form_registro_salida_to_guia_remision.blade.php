...
<form action="" id="formRegistroSalidaToGuiaRemision" method="post">    
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 mb-3">
                <label for="registro_salida" class="required_field" style="font-weight: bold;">REGISTRO SALIDA</label>
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">
                        <img width="30" height="30" src="{{asset('img/icons/documento/documento2.png')}}" alt="coins"/>
                    </span>
                    <input value="{{'RS-'.$registro_salida->id}}" readonly required maxlength="150" value="" name="registro_salida" id="registro_salida" type="text" class="form-control" placeholder="RAZÓN SOCIAL" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <span class="registro_salida_error msgError"  style="color:red;"></span>
            </div> 
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" value="04" name="codigo_motivo_traslado" id="codigo_motivo_traslado">
                ...
                <span class="codigo_motivo_traslado_error msgError"  style="color:red;"></span>
            </div> 
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 mb-3">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <label for="nro_bultos" class="required_field" style="font-weight: bold;">N° BULTOS</label>
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">
                        <img width="30" height="30" src="{{asset('img/icons/paquete/paquete2.png')}}" alt="coins"/>
                    </span>
                    <input style="background-color: rgb(253, 253, 215);" value="1" required maxlength="10" name="nro_bultos" id="nro_bultos" type="text" class="form-control inputEnteroPositivo" placeholder="PESO TOTAL" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <span class="razon_social_error msgError"  style="color:red;"></span>
            </div> 
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">  
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                <div class="row">
                                    <div class="col-12">
                                        <label for="punto_partida" class="required_field" style="font-weight: bold;">PUNTO PARTIDA</label>
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon1">
                                                <img width="30" height="30" src="{{asset('img/icons_animados/transporte/transporte1.gif')}}" alt="coins"/>
                                            </span>
                                            <input value="{{$proyecto_origen->direccion}}" readonly required type="text" class="form-control" placeholder="PUNTO PARTIDA" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input value="{{$proyecto_origen->departamento_nombre.'-'.$proyecto_origen->provincia_nombre.'-'.$proyecto_origen->distrito_nombre}}" readonly required type="text" class="form-control" placeholder="PUNTO PARTIDA" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div> 
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input value="{{$proyecto_origen->ubigeo}}" readonly required type="text" class="form-control" placeholder="UBIGEO" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div> 
                                </div>
                            </div>  
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input value="{{$proyecto_destino->direccion}}" readonly required type="text" class="form-control" placeholder="PUNTO LLEGADA" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input value="{{$proyecto_destino->departamento_nombre.'-'.$proyecto_destino->provincia_nombre.'-'.$proyecto_destino->distrito_nombre}}" readonly required type="text" class="form-control" placeholder="PUNTO DESTINO" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div> 
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input value="{{$proyecto_destino->ubigeo}}" readonly required type="text" class="form-control" placeholder="UBIGEO" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div> 
                                </div>
                            </div>   
                           ...
                           <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="02" readonly required  name="codigo_modo_traslado" id="codigo_modo_traslado" type="hidden" class="form-control"  aria-label="Username" aria-describedby="basic-addon1">
                                    ...
                                    <span class="modo_traslado_error msgError"  style="color:red;"></span>
                                </div> 

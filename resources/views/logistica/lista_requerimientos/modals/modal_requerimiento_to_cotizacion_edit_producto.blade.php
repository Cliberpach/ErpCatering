<div class="modal fade" id="mdlReqToCotEditProducto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
           ...
           @include('compras.cotizacion_compra.forms.form_edit_item')
...
<script>
    ...
    function eventsMdlReqToCotEditProducto(){
        ...
        document.querySelector('#formEditItem').addEventListener('submit',(e)=>{
            ...
            if(validacionFormEdit){
                ...
                if(actualizacion){
                    ...
                    pintarTableRequerimientoToCotizacionDetalle(lstCotizacionCompra);
                    iniciarDataTableRequerimientoToCotizacionDetalle();
                    $('#mdlReqToCotEditProducto').modal('hide');
    ...
    function openMdlEditItem(){
        $('#mdlReqToCotEditProducto').modal('show');
    }

<form action="" id="formRegistrarRequerimiento" method="post">    
    @csrf     
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
            ...
            <div class="input-group">
                ...
                <input  required value="{{$proyecto->nombre}}" readonly name="proyecto" id="proyecto" type="text" class="form-control" placeholder="PROYECTO" aria-label="Username" aria-describedby="basic-addon1">
            </div>        
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
            ...
            <div class="input-group">
                ...
                <input required value="{{$colaborador->nombre}}" readonly name="supervisor" id="supervisor" type="text" class="form-control" placeholder="SUPERVISOR" aria-label="Username" aria-describedby="basic-addon1">
              </div>        
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{-- <div class="row mt-3">
                            <div class="col-12">
                               @include('requerimientos.registro_compra.tables.table_productos')
                            </div>
                        </div> --}}

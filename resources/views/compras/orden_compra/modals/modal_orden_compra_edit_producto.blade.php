<div class="modal fade" id="mdlOrdenCompraEditProducto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
        ...
        document.querySelector('#formEditItemCotizacionToOrden').addEventListener('submit',(e)=>{
            ...
            if(validacionFormEdit){
                ...
                if(actualizacion){
                    ...
                    $('#mdlOrdenCompraEditProducto').modal('hide');
    ...
    function openMdlEditItem(){
        $('#mdlOrdenCompraEditProducto').modal('show');
    }

    function deleteItem(producto_id){

        const indiceProducto    =   lstOrdenCompra.findIndex((lcd)=>{
        ...
        lstOrdenCompra.splice(indiceProducto,1);
        return true;
    ...
    function actualizarItem(dataFormEdit){
        ...
        lstOrdenCompra[indiceProducto].cantidad      =   dataFormEdit.cantidad;
        lstOrdenCompra[indiceProducto].precio        =   dataFormEdit.precio;
        lstOrdenCompra[indiceProducto].total         =   parseFloat(dataFormEdit.precio) * parseFloat(dataFormEdit.cantidad);
        lstOrdenCompra[indiceProducto].almacen_id    =   dataFormEdit.almacen_id;
        lstOrdenCompra[indiceProducto].almacen_nombre=   dataFormEdit.almacen_nombre;
    ...
    function setProducto(producto_id){
        ...
        const productoIndice    =   lstOrdenCompra.findIndex((lcd)=>{
            return lcd.producto_id == producto_id;
        })
        ...
        const producto_find   =   lstOrdenCompra[productoIndice];

<form action="" id="formEditItem" method="post">    
    ...
    <div class="row">
        ...
        <div class="col-12">
            <label for="item_almacen_edit" style="font-weight: bold;">ALMACÉN</label>
            <div class="input-group mb-3">
                <select name="item_almacen_edit" id="item_almacen_edit" data-placeholder="Seleccionar" class="select2_form">

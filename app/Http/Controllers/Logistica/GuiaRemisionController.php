    ...
    public static function send_sunat(Request $request){
        try {
            ...
            $envio
                ...
                ->setChoferes([$chofer])
                ->setLlegada(new Direction($guia_remision->direccion_origen_ubigeo, $guia_remision->direccion_origen_nombre))
                ->setPartida(new Direction($guia_remision->direccion_destino_ubigeo, $guia_remision->direccion_destino_nombre));
            ...
            if($res->isSuccess()){
                ...
                $guia_to_actualizar->ticket         =   $ticket;

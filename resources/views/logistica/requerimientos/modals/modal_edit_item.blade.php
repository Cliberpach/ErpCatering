...
<script>
    ...
    function deleteItem(producto_id){
        ...
        const indiceProducto    =   lstRequerimientos.findIndex((lcd)=>{
        ...
        lstRequerimientos.splice(indiceProducto,1);
        return true;
    ...
    function actualizarItem(dataFormEdit){
        ...
        lstRequerimientos[indiceProducto].cantidad   =   dataFormEdit.cantidad;
        return true;
    }
    ...
    function setProducto(producto_id){
        ...
        const productoIndice    =   lstRequerimientos.findIndex((lcd)=>{
            return lcd.producto_id == producto_id;
        })
        ...
        const producto_find   =   lstRequerimientos[productoIndice];
